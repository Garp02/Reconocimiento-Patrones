...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.4\textwidth]{Img/fig1_p2.png}
    \caption{Píxeles adyacentes; (a) adyacentes por frontera, (b) adyacentes por esquina.}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.3\textwidth]{Img/fig2_p2.png}
    \caption{Vecindades; (a) vecindades de 4,, (b) vecindades de 8.}
\end{figure}
