...
\begin{enumerate}
    ...
    \item \textbf{Dividir} los datos de forma estratificada en $80\%/20\%$
          ($n_{train}=361$, $n_{test}=91$) usando \texttt{train\_test\_split}
          con \texttt{stratify=y} y \texttt{random\_state=43}. El conjunto de
          prueba se reservó intacto durante toda la experimentación.
...
Como clasificador base para todas las evaluaciones se empleó un \textbf{SVM
    lineal} (\texttt{LinearSVC}, $C=1.0$, \texttt{dual=\textquotesingle auto\textquotesingle},
\texttt{max\_iter=5000}, \texttt{random\_state=43}). La validación cruzada fue $5$-fold
estratificada (\texttt{StratifiedKFold}, \texttt{n\_splits=5}, \texttt{shuffle=True},
\texttt{random\_state=43}). El baseline con las 261 características originales alcanzó
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Img/02_sfs_curva.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Img/03_fisher_ranking.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Img/04_fisher_topk.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Img/05_pca_varianza.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Img/06_pca_2d.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{Img/07_matrices_confusion.png}
