...
Los \textit{boxplots} de la Figura~\ref{fig:cancer-boxplots} comparan las
...
\begin{figure}[H]
    ...
    \caption{\textit{Boxplots} comparativos para los grupos de
        características \textit{mean} (arriba) y \textit{worst} (abajo)
        del conjunto Cancer. Escala logarítmica.}
    \label{fig:cancer-boxplots}
\end{figure}
